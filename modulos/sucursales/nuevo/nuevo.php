    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Sucursales<small>Nuevo registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Nuevo sucursales</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['sucursalgarantias']['guardar']) or  !isset($_SESSION['permisos']['sucursalgarantias']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
            ...
            <div class="box box-info" style="border-color:#000000">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                  	<label for="selectidempresa_ajax" class="col-sm-2 control-label">Idempresa:</label>
                    <div class="col-sm-5">

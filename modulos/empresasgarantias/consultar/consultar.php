...
$resultado=$Oempresasgarantias->mostrar($campoOrden, $orden, $inicial, $cantidadamostrar, $busqueda, $papelera);
if ($resultado=="denegado"){
	echo $_SESSION['msgsinacceso'];
	exit;
}
$filasTotales = $Oempresasgarantias->contar($busqueda, $papelera);
	...
	while ($filas=mysqli_fetch_array($resultado)) { ?>
      		<tr id="iregistro<?php echo $filas['idempresa'] ?>">
                ...
                <td>
					...
					?>
						<form action="../modificar/actualizar.php?n1=empresasgarantias&n2=consultarempresasgarantias" method="post">
...
?>
	<div class="info-box" style="height:120px;" id="iregistro<?php echo $filas['idempresa'] ?>">
    	...
    	<div class="info-box-content">
    		...
    		<span class="info-box-number Crfc" style="font-weight:normal; color:#000000;"><?php echo $filas['rfc'] ?></span>
            <span class="info-box-number Ccomposicion" style="font-weight:normal; font-size:12px;">
				<?php 
				$composicion="";
				if (trim($filas['idempresa'])!=""){
					$composicion=$composicion.", ".$filas['idempresa'];
				}
				echo $composicion;
				?>
			</span>

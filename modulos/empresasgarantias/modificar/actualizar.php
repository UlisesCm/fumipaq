    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Empresasgarantias<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar empresasgarantias</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['empresasgarantias']['modificar']) or  !isset($_SESSION['permisos']['empresasgarantias']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $domiciliofiscal; ?>" name="domiciliofiscal" type="text" class="form-control" id="cdomiciliofiscal" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vregimen">
                        <input value="<?php echo $regimen; ?>" name="regimen" type="text" class="form-control" id="cregimen" />
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vlicencia">
                        <input value="<?php echo $licencia; ?>" name="licencia" type="text" class="form-control" id="clicencia" />

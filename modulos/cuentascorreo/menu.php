		...
		<ul>
			...
			<li>
				<div class="tituloMenu">
					<div id="labelMenu">cuentascorreo</div>
				</div>
			</li>
			<?php
			/////PERMISOS////////////////
			...
			<li>
				...
				<div id="labelMenu">Nuevo cuentacorreo</div>
				</a>
			</li>
			<?php }?>
			...
			<li>
				...
				<div id="labelMenu">Consultar cuentascorreo</div>
				</a>
			</li>
			<?php }?>
			<?php
			...
			<li>
				...
				<div id="labelMenu">Papelera de cuentascorreo</div>
				</a>
			</li>
			<?php }?>

...
$(document).ready(function() {
	...
	$('#cpuertosmtp').permitirCaracteres('0123456789');
				$('#cpuertopop').permitirCaracteres('0123456789');
...
function buscar (busqueda){
	location.href='../consultar/vista.php?link=vista&busqueda='+busqueda+'&n1=cuentascorreo&n2=consultarcuentascorreo';
}

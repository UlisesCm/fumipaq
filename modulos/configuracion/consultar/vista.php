    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Configuración<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar configuracion</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['configuracion']['consultar']) or  !isset($_SESSION['permisos']['configuracion']['acceso'])){

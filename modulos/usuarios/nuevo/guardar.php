...
if($validacion){
	$resultado=$Ousuario->guardar($nombre,$email,$foto,$usuario,$contrasena,$estado,$idperfil,$empresa,$controlaracceso,$horainicio,$horafin,$idregistrorelacionado,$tablarelacionada,$bitacora,$idsucursal);
	if($resultado=="exito"){
		/*CARGAR ARCHIVOS*/
		$mensajeArchivo="";

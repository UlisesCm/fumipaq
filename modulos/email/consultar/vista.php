...
<body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper s">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Catálogo de marcas<small> Consulta</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Consultar marca</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['marcas']['consultar']) or  !isset($_SESSION['permisos']['marcas']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
        	...
        	<?php include("../../../componentes/avisos.php");?>
          	<!-- box -->
            <div class="box box-info" style="border-color:#ec3e4a">

...
function comprobarReglas(){
	...
	if(recuperarCookie("campoOrdenUnidad")!=null){
		campoOrden=recuperarCookie("campoOrdenUnidad");
	...
	if(recuperarCookie("cantidadamostrarUnidad")!=null){
		cantidadamostrar=recuperarCookie("cantidadamostrarUnidad");
	...
	if(recuperarCookie("ordenUnidad")=="asc"){
		orden="ASC"
		$('#asc').attr('checked', true);
		$('#desc').attr('checked', false);
	}else if(recuperarCookie("ordenUnidad")=="desc"){
		orden="DESC"
	...
	if(recuperarCookie("mostrarIdunidadUnidad")=="si"){
		$('.Cidunidad').show();
		$('#CheckIdunidad').attr('checked', true);
	}else if(recuperarCookie("mostrarIdunidadUnidad")=="no"){
		$('.Cidunidad').hide();
		$('#CheckIdunidad').attr('checked', false);
	}
	//Mostrar u Ocultar Codigo
	if(recuperarCookie("mostrarCodigoUnidad")=="si"){
		$('.Ccodigo').show();
		$('#CheckCodigo').attr('checked', true);
	}else if(recuperarCookie("mostrarCodigoUnidad")=="no"){
		$('.Ccodigo').hide();
		$('#CheckCodigo').attr('checked', false);
	}
	//Mostrar u Ocultar Nombre
	if(recuperarCookie("mostrarNombreUnidad")=="si"){
		$('.Cnombre').show();
		$('#CheckNombre').attr('checked', true);
	}else if(recuperarCookie("mostrarNombreUnidad")=="no"){
		$('.Cnombre').hide();
		$('#CheckNombre').attr('checked', false);
	}
	//Mostrar u Ocultar Simbolo
	if(recuperarCookie("mostrarSimboloUnidad")=="si"){
		$('.Csimbolo').show();
		$('#CheckSimbolo').attr('checked', true);
	}else if(recuperarCookie("mostrarSimboloUnidad")=="no"){
		$('.Csimbolo').hide();
		$('#CheckSimbolo').attr('checked', false);
	}
	//Mostrar u Ocultar Composicion
	if(recuperarCookie("mostrarComposicionUnidad")=="si"){
		$('.Ccomposicion').show();
		$('#CheckComposicion').attr('checked', true);
	}
	if(recuperarCookie("mostrarComposicionUnidad")=="no"){
		$('.Ccomposicion').hide();
		$('#CheckComposicion').attr('checked', false);
	}
	
	//Elegir el tipo de vista
	if(recuperarCookie("tipoVistaUnidad")=="tabla"){
		$('.tipoLista').show();
		$('.tipoTabla').hide();
		tipoVista="tabla";
	}else{
	...
	$( ".tipoTabla" ).click(function() {
    	crearCookie("tipoVistaUnidad", "tabla");
		tipoVista="tabla";
		$(".tipoLista").show();
		$(".tipoTabla").hide();
	...
	$( ".tipoLista" ).click(function() {
    	crearCookie("tipoVistaUnidad", "lista");
		tipoVista="lista";
		$(".tipoLista").hide();
		$(".tipoTabla").show();
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
...
$(document).ready(function() {
	...
	$("#campoOrden").change(function(){
		...
		crearCookie("campoOrdenUnidad", campoOrden);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$("#cantidadamostrar").change(function(){
		cantidadamostrar = this.value;
		crearCookie("cantidadamostrarUnidad", cantidadamostrar);
		load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
	});
	$( "#asc" ).click(function() {
    	if ($( "#asc" ).is(':checked')){
			crearCookie("ordenUnidad", "asc");
			orden="ASC"
			load_tablas(campoOrden,orden,cantidadamostrar,paginacion,"",tipoVista);
		}
	});
	...
	$( "#CheckIdunidad" ).click(function() {
    	if ($( "#CheckIdunidad" ).is(':checked')){
			crearCookie("mostrarIdunidadUnidad", "si");
			$('.Cidunidad').show();
		}else{
			crearCookie("mostrarIdunidadUnidad", "no");
			$('.Cidunidad').hide();
		}	
	});
	$( "#CheckCodigo" ).click(function() {
    	if ($( "#CheckCodigo" ).is(':checked')){
			crearCookie("mostrarCodigoUnidad", "si");
			$('.Ccodigo').show();
		}else{
			crearCookie("mostrarCodigoUnidad", "no");
			$('.Ccodigo').hide();
		}	
	});
	$( "#CheckNombre" ).click(function() {
    	if ($( "#CheckNombre" ).is(':checked')){
			crearCookie("mostrarNombreUnidad", "si");
			$('.Cnombre').show();
		}else{
			crearCookie("mostrarNombreUnidad", "no");
			$('.Cnombre').hide();
		}	
	});
	$( "#CheckSimbolo" ).click(function() {
    	if ($( "#CheckSimbolo" ).is(':checked')){
			crearCookie("mostrarSimboloUnidad", "si");
			$('.Csimbolo').show();
		}else{
			crearCookie("mostrarSimboloUnidad", "no");
			$('.Csimbolo').hide();
		}	
	});
	$( "#CheckComposicion" ).click(function() {
    	if ($( "#CheckComposicion" ).is(':checked')){
			crearCookie("mostrarComposicionUnidad", "si");
			$('.Ccomposicion').show();
		}else{
			crearCookie("mostrarComposicionUnidad", "no");
			$('.Ccomposicion').hide();
		}
	});

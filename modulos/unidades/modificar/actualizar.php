    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Unidad<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar unidad</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['unidades']['modificar']) or  !isset($_SESSION['permisos']['unidades']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#eb2e4f">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vcodigo">
                        <input value="<?php echo $codigo; ?>" name="codigo" type="text" class="form-control" id="ccodigo" />
				...
				<div class="form-group">
                    ...
                    <div class="col-sm-3">
                    	<span id="Vsimbolo">
                        <input value="<?php echo $simbolo; ?>" name="simbolo" type="text" class="form-control" id="csimbolo" />
            			<span class="textfieldMaxCharsMsg">Se ha superado el número máximo de caracteres.</span>
					<span class="textfieldMinCharsMsg">No se cumple el mínimo de caracteres requerido.</span>
						<span class="textfieldRequiredMsg">Se necesita un valor.</span>
					</span>
                ...
                <div class="box-footer">
				  <input name="idunidad" type="hidden" id="cidunidad" value="<?php echo $id;?>"/>

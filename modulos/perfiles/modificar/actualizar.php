  ...
  <body class="sidebar-mini <?php include("../../../componentes/skin.php");?>">
    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Perfil<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['perfiles']['guardar']) or  !isset($_SESSION['permisos']['perfiles']['acceso'])){
	...
	/////FIN  DE PERMISOS////////
			...
			<?php include("../../../componentes/avisos.php");?>
          	...
          	<!-- Horizontal Form -->
            <div class="box box-info" style="border-color:#0096ce">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group">
                    <label for="cnombre" class="col-sm-2 control-label">Nombre del perfíl:</label>
                    <div class="col-sm-5">
                    	<span id="Vnombre">
				...
				<div class="form-group">
                    <label for="ccolor" class="col-sm-2 control-label">Color de identificación:</label>
                    <div class="col-sm-2">
                    	
                        <input value="<?php echo $color; ?>" name="color" type="color" class="form-control" id="ccolor" />
              ...
              <div id="loading" class="overlay" style="display:none">
  					<i class="fa fa-cog fa-spin" style="color:#0096ce"></i>
			  </div>
...
var sprytextfield1 = new Spry.Widget.ValidationTextField("Vnombre", "none", {validateOn:["blur"],  maxChars:20,  minChars:1});
				var sprytextfield1 = new Spry.Widget.ValidationTextField("Vnombre", "none", {validateOn:["blur"],  maxChars:20,  minChars:1});

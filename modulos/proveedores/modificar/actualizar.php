    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Proveedores<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
            <li><a href="../../inicio/inicio/inicio.php"><i class="fa fa-dashboard"></i> Inicio</a></li>
            <li><a href="#">Modificar proveedores</a></li>
          </ol>
        </section>
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['proveedores']['modificar']) or  !isset($_SESSION['permisos']['proveedores']['acceso'])){
            ...
            <div class="box box-info" style="border-color:#000000">
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                    	<span id="Vdireccion">
                        <input value="<?php echo $direccion; ?>" name="direccion" type="text" class="form-control" id="cdireccion" />

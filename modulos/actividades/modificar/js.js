...
$(document).ready(function() {
	...
	llenarSelectModeloimpuestos(idmodeloimpuestosSeleccionado,"");
	llenarSelectUnidad(idunidadSeleccionado,"");
	llenarSelectCategoria(idcategoriaSeleccionado,"");
	llenarChecksServicios(idactividadSeleccionada,"");
...
function buscar (busqueda){
	location.href='../consultar/vista.php?link=vista&busqueda='+busqueda+'&n1=actividades&n2=consultaractividades';
}

function llenarSelectModeloimpuestos(seleccionado,condicion){
...
function llenarSelectUnidad(seleccionado,condicion){
...
function llenarSelectCategoria(seleccionado,condicion){
...
function llenarChecksServicios(seleccionado,condicion){
		$("#servicios_ajax").html("Cargando servicios...");
		$.ajax({
			url: '../componentes/llenarChecksServicios.php',
			type: "POST",
			data: "submit=&condicion="+condicion+"&seleccionado="+seleccionado, //Pasamos los datos en forma de array seralizado desde la funcion de envio
			success: function(mensaje){
				$("#servicios_ajax").html(mensaje);
			}
		});
		return false;
}

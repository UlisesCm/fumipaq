...
if (isset($_POST['idactividad'])){
	$idactividad=htmlentities(trim($_POST['idactividad']));
	//$idactividad=mysql_real_escape_string($idactividad);
}else{
	$validacion=false;
	$mensaje=$mensaje."<p>El campo idactividad no es correcto</p>";
}
...
if($validacion){
	$resultado=$Oactividad->actualizar($nombre,$idmodeloimpuestos,$tipoformato,$idunidad,$idcategoria,$servicios,$estatus,$idactividad);
	if($resultado=="exito"){

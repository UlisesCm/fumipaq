          ...
          <ul class="dropdown-menu dropdown-menu-form" style="min-width:250px;;">
            ...
            <li><a>
            	<select id="campoOrden" class="form-control input-sm">
									...
									<option value="tipoformato">Formato de captura</option>
                </select>
                </a>
    		</li>
            ...
            <li><span class="titulo-herramientas">Mostrar / Ocultar campos</span></li>
				...
				<li><a><input id="CheckIdmodeloimpuestos" name="kidmodeloimpuestos" value="si" checked="checked" type="checkbox"/><label for="CheckIdmodeloimpuestos">&nbsp;&nbsp;Impuestos</label></a></li>
			
				<li><a><input id="CheckTipoformato" name="ktipoformato" value="si" checked="checked" type="checkbox"/><label for="CheckTipoformato">&nbsp;&nbsp;Formato de captura</label></a></li>

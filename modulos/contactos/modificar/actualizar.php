    ...
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          <h1>Contacto<small>Modificar registro</small>
          </h1>
          <ol class="breadcrumb">
		...
		<?php
    /////PERMISOS////////////////
		if (!isset($_SESSION['permisos']['contactos']['modificar']) or  !isset($_SESSION['permisos']['contactos']['acceso'])){
			  ...
			  <form class="form-horizontal" name="formulario" id="formulario" method="post">
				...
				<div class="form-group ">
                    ...
                    <div class="col-sm-5">
                        ...
                        <input value="<?php echo $departamento; ?>" name="departamento" type="text" class="form-control" id="cdepartamento" />
                ...
                <div class="box-footer">
				  <input name="idcontacto" type="hidden" id="cidcontacto" value="<?php echo $id;?>"/>
